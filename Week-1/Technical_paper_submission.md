...
- **Client** - Sends requests to access or modify resources.
- **Server** - Processes requests and sends appropriate responses.
- **Resources** - Key enitities exposed by APIs.
- **HTTP Methods** - Use to perform CRUD operations on the resources (GET, POST, PUT, DELETE).
- **Representations** - Data format representing resource state.
- **Hypermedia Links** - Embedded links in responses to enable dynamic navigation.
- **Status Codes** - Indicate the status of request (200,400).
